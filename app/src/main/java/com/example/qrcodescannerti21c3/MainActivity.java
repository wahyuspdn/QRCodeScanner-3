    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (result !=null) {
            ...
            if (result.getContents() == null) {
                ...
                intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"wahyusaepudin112@gmail.com"});
                intent.putExtra(Intent.EXTRA_CC, new String[]{"madezikri13@gmail.com"});
                intent.putExtra(Intent.EXTRA_SUBJECT, "Fungsi Email");
                intent.putExtra(Intent.EXTRA_TEXT, "Wahyu Saepudin-TI.21.C.3-312110095");
                try {
